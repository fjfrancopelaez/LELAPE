...
# for further details.
#
function DetectAnomalies_FullCheck(   DATA::Array{UInt32, 2},
                            WordWidth::Int,
                            LN0::Int,
                            Operation::String,
                            TraceRuleLength::Int, 
...
function DetectAnomalies_FullCheck(   DATA::Array{UInt64, 2},
                            WordWidth::Int,
                            LN0::Int,
                            Operation::String,
                            TraceRuleLength::Int, 
...
# 4) Candidates from the Trace rule.
    ...
    Candidates = convert.(UInt64,AddressesInExcess(Histogram, NThreshold))
    ...
    if length(PrevCandidates) > 1
        ...
        Matrix4SMCURULE = convert.(UInt64, reshape([ConfirmedCandidates; Histogram[ConfirmedCandidates.+1]], :, 2))
    ...
    Matrix4SHUFFLERULE = convert.(UInt64, reshape([PossibleCandidates; Histogram[PossibleCandidates.+1]], :, 2))
